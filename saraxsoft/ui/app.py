...
from backend.common.config import AppConfig, Client_Status, GameConfig
...
class App(customtkinter.CTk):
    ...
    def __init__(self) -> None:
        ...
        self.icon_path = PathResolver.resolve_path("assets", "favicon.ico")
            ...
            if game_config.client_status == Client_Status.NOT_FOUND:
                ...
                for proc in psutil.process_iter():  # Iterate over all the processes
                    ...
                    if game_config.client_status == Client_Status.RUNNING:
                        ...
                        break
                    if game_config.client_status == Client_Status.MISSING_ADMIN:
